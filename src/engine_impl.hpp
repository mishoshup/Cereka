...
class CerekaImpl {
   public:
    ...
    void          ShowCharacter(const std::string &id, const std::string &filename, const std::string &pos);
    void          HideCharacter(const std::string &id);
    void          Say(const std::string &speaker, const std::string &name, const std::string &text);
